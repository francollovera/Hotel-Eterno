...
import style from './Habitacion12.module.css'
...
const Habitacion12 = () => {
  ...
  const imagenes = useSelector(state => state.gethabitaciones[11]);
  ...
  return (
    <div className={style.containertotal}>
      <NavBar></NavBar>
      <section >
      <h1 className={style.titulo}>Villa Anacay</h1>
