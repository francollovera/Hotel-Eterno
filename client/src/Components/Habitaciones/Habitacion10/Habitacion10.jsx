...
import style from './Habitacion10.module.css'
...
const Habitacion10 = () => {
  ...
  const imagenes = useSelector(state => state.gethabitaciones[9]);
  ...
  return (
    <div className={style.containertotal}>
      <NavBar></NavBar>
      <section >
      <h1 className={style.titulo}>Villa Lavanda</h1>
